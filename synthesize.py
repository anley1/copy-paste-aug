...
transform = A.Compose([
        ...
        CopyPaste(blend=True, sigma=1, pct_objects_paste=1, p=1., gray=True)
...
#)
data = CocoDetectionCP(
    '../Swin-Transformer-Object-Detection/data/flooding_high_cropped_gray',
    '../Swin-Transformer-Object-Detection/data/bead_cropped_detection/Grayscale',
...
data.synthesize(pct=0.5,
                out_dir="out_medium_gray/",
                json_name="aug_medium_gray.json")
